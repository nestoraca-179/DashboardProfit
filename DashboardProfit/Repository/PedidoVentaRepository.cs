...
namespace DashboardProfit.Repository
{
	public class PedidoVentaRepository : ProfitAdmManager
	{
		...
		public List<RepPedidoVentaxNum_Result> getLastTopOrders(DateTime from, DateTime to, int top)
		{
			...
			var sp = db.RepPedidoVentaxNum(null, null, from, to, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null).GetEnumerator();

			while (sp.MoveNext())
			{
				RepPedidoVentaxNum_Result item = sp.Current;
		...
		public List<RepPedidoVentaxReng_Result> getLastTopOrdersByLine(DateTime from, DateTime to, int top)
		{
			...
			var sp = db.RepPedidoVentaxReng(null, null, from, to, null, null, null, null, null, null, null, null, null, null, null, null, null, null).GetEnumerator();
