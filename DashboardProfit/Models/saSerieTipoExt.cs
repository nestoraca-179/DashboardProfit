...
namespace DashboardProfit.Models
{
    ...
    public partial class saSerieTipoExt
    {
        ...
        public virtual saAreaImpresion saAreaImpresion { get; set; }
        public virtual saPuntoEmision saPuntoEmision { get; set; }
    }
}
