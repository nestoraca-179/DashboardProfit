<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeleccionEmpresa.aspx.cs" Inherits="DashboardProfit.SeleccionEmpresa" %>
...
<head runat="server">
    ...
    <title>Seleccion Empresa | Dashboard</title>
        ...
        <form id="form1" runat="server">
            ...
            <div class="col-md-12 text-center pt-2 pb-5">
                <asp:Button ID="BTN_Send" runat="server" CssClass="btn btn-primary w-50 px-5 py-3 disabled" OnClick="BTN_Send_Click" style="text-transform: none;" ClientIDMode="Static"
                    OnClientClick="javascript:$('#BTN_Send').addClass('disabled', 'true')" Text="Seleccionar empresa" AutoPostBack="false">
                </asp:Button>
            </div>
        </form>
    </section>
